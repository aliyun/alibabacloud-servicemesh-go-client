...
import (
	v1 "istio.io/client-go/asm/pkg/clientset/versioned/typed/alibabacloudservicemesh/v1"
...
func (c *FakeIstioV1) ASMHashTaggings(namespace string) v1.ASMHashTaggingInterface {
	return &FakeASMHashTaggings{c, namespace}
}
