...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1beta1.SchemeGroupVersion.WithResource("scopeconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Istio().V1beta1().ScopeConfigs().Informer()}, nil
